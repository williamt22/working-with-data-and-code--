...
pause(4000)
adventure.clear_text_log()
adventure.add_to_textlog("In your surroundings you see a clearing between two trees, or a cave opening. Which will you choose?")
pause(4000)
adventure.clear_text_log()
game.show_long_text("Tree (A)      Cave (B)", DialogLayout.BOTTOM)