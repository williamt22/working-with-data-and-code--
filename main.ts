...
controller.B.onEvent(ControllerButtonEvent.Pressed, function () {
    ...
    if (B == 0) {
        ...
        Tree.setImage(assets.image`myImage`)
        adventure.addToTextlog("After what feels like hours of walking in the dark you reach a broad open space. ")
        pause(3000)
        adventure.clearTextLog()
        adventure.addToTextlog("You see the path split into two, an upper and a lower path.")
        pause(2500)
        adventure.clearTextLog()
        adventure.addToTextlog("Which will you choose?")
        pause(3000)
        adventure.clearTextLog()
        adventure.addToTextlog("Upper (A)     Lower (B)")
        pause(2000)
        adventure.clearTextLog()
    }
...
controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    ...
    if (A == 0) {
        ...
        pause(1500)
        adventure.clearTextLog()
        adventure.addToTextlog("You make your way between the two tree clearings. ")
        pause(2000)
        adventure.clearTextLog()
        adventure.addToTextlog("After what feels like hours of walking you approach a river. ")
        Tree.setImage(img`
            ........................
            ........................
            ........................
    ...
    if (A == -1) {
        ...
        pause(2000)
        adventure.clearTextLog()
        adventure.addToTextlog("After walking you notice rocks slowly falling around you.")
        pause(2000)
        adventure.clearTextLog()
        adventure.addToTextlog("You continue walking, your nerves heightening.")
        pause(3000)
        adventure.clearTextLog()
        adventure.addToTextlog("A giant stalactite falls down from the ceiling, impaling you!")
        Tree.setImage(assets.image`myImages.image0`)
        pause(3000)
        adventure.clearTextLog()
        // This signals the end of the game and creates a splash screen that says the player has lost. 
